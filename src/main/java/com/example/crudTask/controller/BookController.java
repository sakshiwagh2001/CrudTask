...
import com.example.crudTask.model.BookModel;
import com.example.crudTask.service.BookService;
...
public class BookController {
    ...
    @GetMapping("/create")
    @PreAuthorize("hasRole('ADMIN')")  // Only ADMIN can access this page
    ...
    @PreAuthorize("hasRole('ADMIN')")  // Only ADMIN can create a book
